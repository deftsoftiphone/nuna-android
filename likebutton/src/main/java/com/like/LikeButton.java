...
public class LikeButton extends FrameLayout implements View.OnClickListener {
    ...
    private OnAnimationListener animationEndListener;
    ...
    public void onClick(View v) {
        if (Utils.CheckIfHasNetwork(v.getContext())) {
            if (!isEnabled)
                return;
    ...
    public void setLikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            likeDrawable = Utils.resizeDrawable(getContext(), likeDrawable, iconSize, iconHeight);
        }
    ...
    public void setLikeDrawable(Drawable likeDrawable) {
        ...
        if (iconSize != 0) {
            this.likeDrawable = Utils.resizeDrawable(getContext(), likeDrawable, iconSize, iconHeight);
        }
    ...
    public void setUnlikeDrawableRes(@DrawableRes int resId) {
        ...
        if (iconSize != 0) {
            unLikeDrawable = Utils.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconHeight);
        }
    ...
    public void setUnlikeDrawable(Drawable unLikeDrawable) {
        ...
        if (iconSize != 0) {
            this.unLikeDrawable = Utils.resizeDrawable(getContext(), unLikeDrawable, iconSize, iconHeight);
        }
     ...
     */
    public void setOnAnimationEndListener(OnAnimationListener animationEndListener) {

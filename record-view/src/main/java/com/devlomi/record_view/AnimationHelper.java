...
public class AnimationHelper {
    ...
    private BasketAnimationListener onBasketAnimationEndListener;
        ...
        translateAnimation1.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                if (onBasketAnimationEndListener != null) {
                    onBasketAnimationEndListener.onAnimationStart();
                }
            }
    ...
    public void setOnBasketAnimationEndListener(BasketAnimationListener basketAnimationListenerListener) {
        this.onBasketAnimationEndListener = basketAnimationListenerListener;

...
public class RecordView extends RelativeLayout {
    ...
    private RecordButtonTouchListener touchListener;

    public void setTouchListener(RecordButtonTouchListener touchListener) {
    ...
    protected void onActionMove(RecordButton recordBtn, MotionEvent motionEvent) {
        ...
        if (!isSwiped) {
            ...
            if (slideToCancelLayout.getX() != 0 && slideToCancelLayout.getX() <= counterTime.getRight() + cancelBounds) {
                ...
                boolean isLessThanOneSec = isLessThanOneSecond(time);
                if (isLessThanOneSec) {
                    hideViews(true);
                ...
                if (isLessThanOneSec) animationHelper.onAnimationEnd();
                if (touchListener!=null) touchListener.onTouchReleased();
    ...
    public void setOnBasketAnimationListener(BasketAnimationListener onBasketAnimationEndListener) {

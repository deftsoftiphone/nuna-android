...
class Prefs {
    ...
    private val PREF_MUEBERT_PAT = "_PREF_MUEBERT_PAT"
    ...
    private val PREF_CURRENT_NOTIFICATION_COUNT = "_CURRENT_NOTIFICATION_COUNT"
    ...
    var notificationCount: Int
        get() {
            val sF = MainApplication.get().getContext()
                .getSharedPreferences(PREF_NAME_GLOBAL, MODE_PRIVATE)
            return sF.getInt(PREF_CURRENT_NOTIFICATION_COUNT, 0)
        }
        set(value) {
            val sF = MainApplication.get().getContext()
                .getSharedPreferences(PREF_NAME_GLOBAL, MODE_PRIVATE)
            sF.edit().putInt(PREF_CURRENT_NOTIFICATION_COUNT, value).apply()
        }


    var muebertPAT: String
        get() {
            val sF = MainApplication.get().getContext()
                .getSharedPreferences(PREF_NAME_GLOBAL, MODE_PRIVATE)
            return sF.getString(PREF_MUEBERT_PAT, "") ?: ""
        }
        set(value) {
            val sF = MainApplication.get().getContext()
                .getSharedPreferences(PREF_NAME_GLOBAL, MODE_PRIVATE)
            sF.edit().putString(PREF_MUEBERT_PAT, value).apply()
        }

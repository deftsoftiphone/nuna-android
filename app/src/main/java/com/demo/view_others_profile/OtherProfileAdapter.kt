...
class OtherProfileAdapter(override val layoutId: Int,private val postClickListener: PostClickListener) :
    ...
    override fun bind(
        ...
        holder.binding.root.setOnClickListener {postClickListener.onPostClick(position,item)}
...
//                        url = strurl
    ...
    interface PostClickListener {
        fun onPostClick(position: Int,item: Post)
    }
}
